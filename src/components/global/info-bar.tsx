...
const InfoBar = ({ notifications, subAccountId, className, role }: Props) => {
  ...
  return (
    <>
      <div
        className={twMerge(
          'fixed z-[20] md:left-[300px] left-0 right-0 top-0 p-4 bg-background/80 backdrop-blur-md flex  gap-4 items-center border-b-[1px] overflow-hidden',
          className
        )}
      >
          ...
          <Sheet>
            ...
            <SheetContent className="mt-4 mr-4 pr-4 overflow-scroll">
              ...
              {allNotifications?.map((notification) => (
                <div
                  key={notification.id}
                  className="flex flex-col gap-y-2 mb-2 mt-2 text-ellipsis"
                >
